...
1. **Read before writing.** Read the relevant section in [RESEARCH.md](../../docs/RESEARCH.md) before making any edit.
2. **Check other docs.** Scan [ARCHITECTURE.md](../../docs/ARCHITECTURE.md) and [STORYLINE.md](../../docs/STORYLINE.md) for related text that may also need updating (e.g., Mermaid diagrams referencing the same mechanic, summary tables with the same data).
...
6. **No unsupported claims.** Every factual statement about game mechanics must have a source citation. If you cannot cite it, do not write it. Log unknowns in [PROBLEMS.md](../../docs/PROBLEMS.md).
