...
All spawn/placement/terrain primitives referenced above are normatively specified in their own logic docs. This file documents only the entry-point dispatcher and delegates everything else by cross-reference.
