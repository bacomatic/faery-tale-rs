...
> Derived from [RESEARCH.md](https://github.com/bacomatic/faery-tale-rs/blob/research/reference/RESEARCH.md), [ARCHITECTURE.md](https://github.com/bacomatic/faery-tale-rs/blob/research/reference/ARCHITECTURE.md), and [STORYLINE.md](https://github.com/bacomatic/faery-tale-rs/blob/research/reference/STORYLINE.md) on the `research` branch.
