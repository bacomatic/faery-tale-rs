...
| R-DEATH-008 | Fairy animation at `goodfairy` 119–20: sprite approaches hero, `battleflag = FALSE`, AI suspended. At `goodfairy` 19–1: fairy stationary at `hero_x + 20`. Revival `revive(false)` at `goodfairy == 1`. |
